...
var securityReasonJA = map[string]string{
	...
	"Homebrew cask download host is under the homepage host; vendor provenance verified from Homebrew metadata": "Homebrew metadata で、cask のダウンロード元 host が homepage host 配下であることを確認済みです",
